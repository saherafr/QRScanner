...
public class CheckGeolocationSwitchTest {
	...
	public void BrowseEventsDisplayTest() {
		...
		onView(withId(R.id.switch_geo_location)).check(matches(isDisplayed()));
		onView(withId(R.id.switch_geo_location)).perform(click( ));
