...
public class AdminEventMenuCheckTest {
	...
	@Test
	public void EventMenuAdminTest() {
		...
		onView(withId(R.id.browse_users)).check(matches(isDisplayed()));

		// Check if browse_images button is displayed
		onView(withId(R.id.browse_images)).check(matches(isDisplayed()));

		// Check if admin_browse_events button is displayed
